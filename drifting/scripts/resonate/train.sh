...
export EVAL_FAILURE_FATAL="${EVAL_FAILURE_FATAL:-1}"
export EVAL_COMPLETION_POLL_SECONDS="${EVAL_COMPLETION_POLL_SECONDS:-5}"
export EVAL_COMPLETION_TIMEOUT_MINUTES="${EVAL_COMPLETION_TIMEOUT_MINUTES:-0}"
...
SAVE_INTERVAL_VALUE="${SAVE_ITS:-${SAVE_INTERVAL:-1000}}"
...
printf 'train_config EVAL_FAILURE_FATAL=%s\n' "${EVAL_FAILURE_FATAL}"
printf 'train_config EVAL_WAIT_MODE=file-poll-then-short-nccl-barrier\n'
printf 'train_config EVAL_COMPLETION_POLL_SECONDS=%s\n' \
  "${EVAL_COMPLETION_POLL_SECONDS}"
printf 'train_config EVAL_COMPLETION_TIMEOUT_MINUTES=%s\n' \
  "${EVAL_COMPLETION_TIMEOUT_MINUTES}"
