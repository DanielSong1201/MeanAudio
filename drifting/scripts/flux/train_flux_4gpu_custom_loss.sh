...
print_config "ARCHIVE_TRAIN_STATE_INTERVAL" "${ARCHIVE_TRAIN_STATE_INTERVAL_VALUE}"
...
print_config "RESUME_PATH" "${RESUME_PATH_VALUE:-disabled}"
print_config "RESUME_ITERATION" "${RESUME_ITERATION_VALUE:-infer}"
print_config "RESUME_EMA_PATH" "${RESUME_EMA_PATH_VALUE:-auto}"
print_config "RESET_OPTIMIZER" "${RESET_OPTIMIZER_VALUE}"
