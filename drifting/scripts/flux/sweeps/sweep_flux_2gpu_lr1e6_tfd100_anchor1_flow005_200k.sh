...
EVAL_OUTPUT_ROOT="${EVAL_OUTPUT_ROOT:-exps/drifting_flux_eval}" \
EVAL_GT_CACHE="${EVAL_GT_CACHE:-data/audiocaps/test-features}" \
EVAL_NUM_STEPS="${EVAL_NUM_STEPS:-1}" \
EVAL_CFG_STRENGTH="${EVAL_CFG_STRENGTH:-4.5}" \
